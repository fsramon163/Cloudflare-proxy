...
let subPath = 'laowang';     // 节点订阅路径,不修改将使用uuid作为订阅路径
let password = '12879583';  // 主页密码,建议修改或添加 PASSWORD环境变量
let proxyIP = '13.230.34.30';  // proxyIP 格式：ip、域名、ip:port、域名:port等,没填写port，默认使用443
let yourUUID = 'b67238d7-cef4-4f07-a3c9-5b31df39fa06'; // UUID,建议修改或添加环境便量
